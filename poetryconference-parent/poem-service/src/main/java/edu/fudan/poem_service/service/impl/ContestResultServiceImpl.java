...
import edu.fudan.poem_service.repository.ContestResultRepository;
...
public class ContestResultServiceImpl implements ContestResultService {
    ...
    @Override
    public List<ContestResultVo> getUserContestResults(Long userId) {
        ...
        return contestResults.stream().map(this::convertToVo).collect(Collectors.toList());
    }
    ...
    private ContestResultVo convertToVo(ContestResult contestResult) {
        ContestResultVo dto = new ContestResultVo();
